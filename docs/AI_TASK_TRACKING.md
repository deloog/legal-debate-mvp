...
- src/__tests__/performance/page-load.test.ts - 性能测试（100行）✅
...
- src/__tests__/backend-performance.test.ts - 性能测试套件（~330行）✅
...
- src/__tests__/e2e/debate-flow/helpers.ts - 增加轮询超时配置✅
