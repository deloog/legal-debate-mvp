...
// =============================================================================
// 最终版文档解析准确性测试脚本
// 使用优化版DocAnalyzer + AI验证，完全避免算法匹配
// =============================================================================
...
interface FinalAccuracyMetrics {
...
class FinalDocumentAccuracyTester {
  ...
  async runFinalAccuracyTest(): Promise<void> {
    ...
    const testDocuments: TestDocument[] = [
      {
        id: 'civil-case-001',
        filePath: join(__dirname, '../test-data/legal-documents/sample-civil-case.txt'),
        fileType: 'TXT',
      ...
      },
      {
        ...
        filePath: join(__dirname, '../test-data/legal-documents/test-variation-civil-case.txt'),
        fileType: 'TXT',
    ...
    const results: FinalAccuracyMetrics[] = [];
  ...
  private async testDocumentWithFinalAIVerification(testDoc: TestDocument): Promise<FinalAccuracyMetrics> {
  ...
  private printFinalResults(docId: string, description: string, metrics: FinalAccuracyMetrics): void {
  ...
  private generateFinalReport(results: FinalAccuracyMetrics[]): void {
    ...
    // 保存报告
    const reportPath = join(__dirname, '../test-data/final-accuracy-report.json');
...
export { FinalDocumentAccuracyTester };
