...
async function testDownload() {
  ...
  const testCases = [
    {
      path: 'prod/20180311/0193ce7784e64a83b575aadb5e0b8622.docx',
      name: '2018宪法修正案',
    },
    {
      path: 'prod/20180311/f7d150ac603e48628fb970321b38a145.docx',
      name: '2018宪法文本',
    },
    {
      path: 'prod/20040314/dcf90fd833be4e3bb3cc9eb1773fb07d.docx',
      name: '2004宪法修正案',
    },
  ];
