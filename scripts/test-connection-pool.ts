import { connectionManager, ConnectionManager, ConnectionPoolError } from '../src/lib/db/connection-manager';
import { getPoolStats, checkPoolHealth, warmupConnectionPool } from '../src/lib/db/connection-pool';
...
class ConnectionPoolStressTester {
  ...
  // 1. 基础并发连接测试
  async testConcurrentConnections(config: PoolTestConfig): Promise<StressTestResult> {
