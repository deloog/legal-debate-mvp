...
export function checkNamingConventions(filePath, content) {
  ...
  if (snakeCaseVars.length > 0) {
    issues.push(`发现snake_case变量名，建议使用camelCase: ${snakeCaseVars.slice(0, MAX_ISSUES_TO_SHOW).join(', ')}`);
  }
  ...
  if (pascalCaseVars.length > 0) {
    issues.push(`发现PascalCase变量名，建议用于类/组件: ${pascalCaseVars.slice(0, MAX_ISSUES_TO_SHOW).join(', ')}`);
  }
