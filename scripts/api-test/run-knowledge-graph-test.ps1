...
if ($Help) {
    Write-Host "${Blue}知识图谱 API 测试脚本${NC}"
    Write-Host ""
    Write-Host "用法: .\run-knowledge-graph-test.ps1 [选项]"
...
Write-Host ""
Write-Host "${Cyan}╔══════════════════════════════════════════════════════════════╗${NC}"
Write-Host "${Cyan}║           🧠 知识图谱业务场景 API 测试                       ║${NC}"
Write-Host "${Cyan}╚══════════════════════════════════════════════════════════════╝${NC}"
Write-Host ""
...
try {
    npx ts-node --project tsconfig.json scripts/api-test/knowledge-graph-workflow-test.ts
    exit $LASTEXITCODE
} catch {
