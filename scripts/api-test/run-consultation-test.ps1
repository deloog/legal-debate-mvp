...
if ($Help) {
    Write-Host "${Blue}咨询业务 API 测试脚本${NC}"
    Write-Host ""
    Write-Host "用法: .\run-consultation-test.ps1 [选项]"
...
Write-Host ""
Write-Host "${Cyan}╔══════════════════════════════════════════════════════════════╗${NC}"
Write-Host "${Cyan}║           📞 咨询业务场景 API 测试                           ║${NC}"
Write-Host "${Cyan}╚══════════════════════════════════════════════════════════════╝${NC}"
Write-Host ""
...
try {
    npx ts-node --project tsconfig.json scripts/api-test/consultation-workflow-test.ts
    exit $LASTEXITCODE
} catch {
