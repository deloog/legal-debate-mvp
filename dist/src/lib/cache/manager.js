...
exports.cache = {
    ...
    getOrSet: (key, valueProvider, options) => exports.cacheManager.getOrSet(key, valueProvider, options),
    ...
    removeEventListener: (listener) => exports.cacheManager.removeEventListener(listener),
};
