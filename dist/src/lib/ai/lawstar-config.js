...
exports.LAWSTAR_CAPABILITIES = exports.TEST_LAWSTAR_CONFIG = exports.PRODUCTION_LAWSTAR_CONFIG = exports.DEVELOPMENT_LAWSTAR_CONFIG = exports.DEFAULT_LAWSTAR_CONFIG = void 0;
...
exports.DEFAULT_LAWSTAR_CONFIG = {
    regulation: {
        baseURL: process.env.LAWSTAR_REGULATION_BASE_URL || "https://api.law-star.com",
...
function isLawStarAvailable() {
    const config = getLawStarConfig();
    return !!(config.regulation.appId &&
