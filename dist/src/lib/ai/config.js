...
exports.PROVIDER_CONFIGS = exports.TEST_AI_CONFIG = exports.PRODUCTION_AI_CONFIG = exports.DEVELOPMENT_AI_CONFIG = exports.DEFAULT_AI_SERVICE_CONFIG = void 0;
...
exports.DEVELOPMENT_AI_CONFIG = {
    ...
    loadBalancer: {
        ...exports.DEFAULT_AI_SERVICE_CONFIG.loadBalancer,
    ...
    fallback: {
        ...exports.DEFAULT_AI_SERVICE_CONFIG.fallback,
        localProcessing: {
            ...exports.DEFAULT_AI_SERVICE_CONFIG.fallback.localProcessing,
...
function validateAIConfig() {
    ...
    if (config.loadBalancer.weights) {
        const totalWeight = Object.values(config.loadBalancer.weights).reduce((sum, weight) => sum + weight, 0);
        if (Math.abs(totalWeight - 1.0) > 0.01) {
            errors.push(`Load balancer weights must sum to 1.0, current sum: ${totalWeight}`);
        }
    }
    // 验证默认提供商
    ...
    if (config.defaultProvider &&
        ...
        errors.push(`Default provider ${config.defaultProvider} is not configured in clients`);
    }
    return {
...
function getDefaultModel(provider, type) {
...
// =============================================================================
exports.default = {
    DEFAULT_AI_SERVICE_CONFIG: exports.DEFAULT_AI_SERVICE_CONFIG,
    DEVELOPMENT_AI_CONFIG: exports.DEVELOPMENT_AI_CONFIG,
    PRODUCTION_AI_CONFIG: exports.PRODUCTION_AI_CONFIG,
    TEST_AI_CONFIG: exports.TEST_AI_CONFIG,
    getAIConfig,
    validateAIConfig,
    PROVIDER_CONFIGS: exports.PROVIDER_CONFIGS,
    getProviderConfig,
    getDefaultModel,
    isModelSupported,
    validateModel,
