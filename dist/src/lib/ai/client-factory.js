...
class AIClientFactory {
    ...
    static async createZhipuClient(config) {
        try {
            ...
            console.warn("OpenAI client not available for Zhipu, using mock client. Error:", error);
    ...
    static async createDeepSeekClient(config) {
        try {
            ...
            console.warn("DeepSeek client not available, using mock client. Error:", error);
    ...
    static async createOpenAIClient(config) {
        try {
            ...
            console.warn("OpenAI client not available, using mock client. Error:", error);
    ...
    static async createAnthropicClient(config) {
        try {
            ...
            console.warn("Anthropic client not available, using mock client. Error:", error);
