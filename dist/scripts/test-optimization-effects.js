...
class OptimizationTester {
  constructor() {
    ...
    this.claimClassifier =
      new lawsuit_request_classifier_1.LawsuitRequestClassifier();
    this.amountExtractor =
      new amount_extractor_precision_1.PrecisionAmountExtractor();
  }
  /**
   * 运行优化效果测试
   */
  ...
  loadTestDocuments() {
    ...
    try {
      // 测试文档1：复杂的民事纠纷
      const civilCasePath = (0, path_1.join)(
        process.cwd(),
...
async function main() {
  ...
  try {
    ...
    const reportPath = (0, path_1.join)(
      __dirname,
      "../optimization-effect-report.json",
    );
