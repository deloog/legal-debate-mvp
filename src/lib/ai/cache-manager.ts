...
export class AICacheManager {
   ...
   * 检查缓存
   */
  public async checkCache(request: AIRequestConfig): Promise<AIResponse | null> {
   ...
   * 添加到相似案件索引
   */
  private async addToSimilarCaseIndex(similarKey: string, cacheKey: string): Promise<void> {
    try {
