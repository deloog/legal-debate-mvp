...
export function validateAIConfig(): { valid: boolean; errors: string[] } {
  ...
  if (config.defaultProvider && !availableProviders.includes(config.defaultProvider)) {
...
export function getProviderConfig(provider: AIProvider): typeof PROVIDER_CONFIGS[AIProvider] {
  return PROVIDER_CONFIGS[provider];
}

export function getDefaultModel(provider: AIProvider, type: 'chat' | 'embedding'): string {
