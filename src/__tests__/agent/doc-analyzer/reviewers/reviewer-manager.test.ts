...
import { ReviewerManager, IReviewer } from '../../../../lib/agent/doc-analyzer/reviewers/reviewer-manager';
import type { ExtractedData, ReviewResult, ReviewerConfig } from '../../../../lib/agent/doc-analyzer/core/types';
