...
describe('Pagination Core', () => {
  describe('buildPaginationOptions', () => {
    ...
    it('should handle different sort fields with orders', () => {
      const testCases = [
        ...
        { sort: 'created', order: 'asc' as const, expected: { created: 'asc' } },
      ];
  ...
  describe('validatePaginationParams', () => {
    ...
    it('should handle zero values', () => {
      ...
      expect(() => validatePaginationParams(params)).toThrow('Page must be greater than 0');
    });
    ...
    it('should handle limit too small', () => {
      ...
      expect(() => validatePaginationParams(params)).toThrow('Limit must be between 1 and 100');
    });
  ...
  describe('Integration Tests', () => {
    it('should work together for complete pagination flow', () => {
      ...
      const searchOptions = buildSearchOptions({ ...validatedParams, search: 'test' });
