...
describe('API Response Utilities', () => {
  ...
  describe('createDownloadResponse', () => {
    ...
    it('should create download response with ReadableStream', () => {
      ...
      const response = createDownloadResponse(stream, filename, 'application/json');
    ...
    it('should handle special characters in filename', () => {
      ...
      expect(response.headers.get('Content-Disposition')).toContain('attachment; filename="test file (1).pdf"');
    });
  });
