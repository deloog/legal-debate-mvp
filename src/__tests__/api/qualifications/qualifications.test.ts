...
describe('Qualification API Security Tests', () => {
  ...
  describe('Photo Access Security', () => {
    it('should validate file ID format correctly', () => {
      ...
      expect(isValidFileId('qual-ln5y6it-abcd1234abcd1234abcd1234abcd1234')).toBe(true);
  ...
  describe('Qualification Upload Security', () => {
    ...
    it('should validate basic info before processing', () => {
      mockValidateBasicInfo.mockReturnValue({ valid: false, errors: { licenseNumber: '格式错误' } });
    ...
    it('should prevent duplicate license numbers', async () => {
      mockPrisma.lawyerQualification.findUnique.mockResolvedValue({ id: 'existing-qual' });

      const existingQualification = await mockPrisma.lawyerQualification.findUnique({
    ...
    it('should prevent multiple qualifications per user', async () => {
      mockPrisma.lawyerQualification.findMany.mockResolvedValue([{ id: 'qual-1' }, { id: 'qual-2' }]);
  ...
  describe('License Number Validator Security', () => {
    ...
    it('should clean and normalize license numbers', () => {
      ...
      expect(cleanLicenseNumber('12345-67890-12345-67')).toBe('12345678901234567');
      expect(cleanLicenseNumber('12345 67890 12345 67')).toBe('12345678901234567');
      expect(cleanLicenseNumber('12345- 67890 -12345- 67')).toBe('12345678901234567');
    });
  });
