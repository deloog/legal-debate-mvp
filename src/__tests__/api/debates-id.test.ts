...
describe('Debates ID API', () => {
  ...
  describe('GET /api/v1/debates/[id]', () => {
    it('should return debate details with related data', async () => {
      ...
      mockReq.url = 'http://localhost:3000/api/v1/debates/123e4567-e89b-12d3-a456-426614174000';
      
      mockedPrisma.debate.findUnique.mockResolvedValue(mockDebate);

      const { GET } = await import('@/app/api/v1/debates/[id]/route');
      const response = await GET(mockReq, { params: { id: '123e4567-e89b-12d3-a456-426614174000' } });
    ...
    it('should validate UUID format', async () => {
      ...
      const response = await GET(
        { ...mockReq, url: 'http://localhost:3000/api/v1/debates/invalid-uuid' },
  ...
  describe('PUT /api/v1/debates/[id]', () => {
    it('should update debate successfully', async () => {
      ...
      const response = await PUT(mockReq, { params: { id: '123e4567-e89b-12d3-a456-426614174000' } });
      const data = await response.json();
  ...
  describe('DELETE /api/v1/debates/[id]', () => {
    it('should delete debate successfully', async () => {
      ...
      const response = await DELETE(mockReq, { params: { id: '123e4567-e89b-12d3-a456-426614174000' } });
      let data;
      try {
    ...
    it('should handle database errors during deletion', async () => {
      mockedPrisma.debate.findUnique.mockResolvedValue({ id: '123' } as any);
      mockedPrisma.debate.delete.mockRejectedValue(new Error('Database connection failed'));
