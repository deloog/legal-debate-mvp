...
describe('CaseExampleService', () => {
  ...
  describe('create', () => {
    it('应该成功创建新案例', async () => {
      ...
      (mockPrisma.caseExample.create as jest.Mock).mockResolvedValue(
        mockExample
      );
  ...
  describe('getById', () => {
    ...
    it('案例不存在时应返回null', async () => {
      (mockPrisma.caseExample.findUnique as jest.Mock).mockResolvedValue(null);
  ...
  describe('delete', () => {
    it('应该成功删除案例', async () => {
      ...
      (mockPrisma.caseExample.delete as jest.Mock).mockResolvedValue(
        mockExample
      );
  ...
  describe('list', () => {
    it('应该成功获取案例列表', async () => {
      ...
      (mockPrisma.caseExample.findMany as jest.Mock).mockResolvedValue(
        mockExamples
      );
      (mockPrisma.caseExample.count as jest.Mock).mockResolvedValue(2);
    ...
    it('应该正确处理分页参数', async () => {
      (mockPrisma.caseExample.findMany as jest.Mock).mockResolvedValue([]);
      (mockPrisma.caseExample.count as jest.Mock).mockResolvedValue(0);
  ...
  describe('getStatistics', () => {
    it('应该正确计算统计信息', async () => {
      (mockPrisma.caseExample.count as jest.Mock).mockResolvedValue(100);
      (mockPrisma.caseExample.groupBy as jest.Mock)
