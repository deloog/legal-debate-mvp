...
import { validatePathParam, validateRequestBody } from '@/app/api/lib/validation/validator';
import { uuidSchema, updateDebateSchema } from '@/app/api/lib/validation/schemas';
