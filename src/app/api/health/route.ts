...
import { createDefaultMiddlewareStack, createRequestContext } from '@/app/api/lib/middleware';
...
export const GET = withErrorHandler(async (request: NextRequest) => {
  ...
  const overallStatus = dbStatus === 'healthy' && aiStatus === 'healthy' ? 'healthy' : 'unhealthy';
