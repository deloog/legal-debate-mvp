...
import { CreateConsultationButton } from './components/create-consultation-button';

/**
 * 咨询管理页面主入口
 * 功能：展示咨询列表、搜索、筛选和快速操作
 */
  ...
  return (
    <div className='space-y-4'>
      {[...Array(5)].map((_, i) => (
        <div
          key={i}
          className='h-56 rounded-lg border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-950'
        >
